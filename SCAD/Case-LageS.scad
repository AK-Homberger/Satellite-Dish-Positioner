...
//internal dimensions
int_l_holder=31;//max length of the item to be held internally
int_b_holder=20;//max breadth of the item to be held internally
int_h_holder=10;//max height of the item to be held internally
...
side_side_separation=5;//how far apart the two halves are if generated together


//cutout variables
cutout_wall_thickness=1*xy_resolution; //how thick is the plastic left in the cutouts on the sides? set to 0 if you do not want any plastic left in these cutouts
...
s_cutout_c=1;//if 1 gives circle just using the _r value and ignoring the others, else gives rounded square
