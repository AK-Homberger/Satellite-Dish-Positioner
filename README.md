...
The delay values in the code ( functions write0() and write1() ) had to be adjusted for the faster ESP8266. The delay with 21 microseconds works perfectly to generate a 22 kHz signal.
